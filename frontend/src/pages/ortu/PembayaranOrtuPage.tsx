    ...
    <div className="space-y-4 max-w-xl mx-auto w-full" style={{ fontFamily: "'Inter', sans-serif" }}>
      ...
      <div className="bg-gradient-to-br from-[#FFF8E1] via-[#FFF3E0] to-[#FFE0B2] border-2 border-[#FFB74D] rounded-2xl shadow-[0_4px_16px_rgba(255,152,0,0.12)] p-5 space-y-4">
        ...
        <a
          ...
          target="_blank"
          rel="noreferrer"
          className="flex items-center justify-center gap-2.5 w-full py-3.5 bg-[#25D366] hover:bg-[#1EBE5D] text-white font-extrabold text-xs rounded-xl shadow-md transition-all active:scale-[0.98]"
        >
          ...
          <span>Konfirmasi Pembayaran ke Owner via WhatsApp</span>
        </a>
      </div>
