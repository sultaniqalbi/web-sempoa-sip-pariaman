...
const TOUR_STEPS: TourStep[] = [
  {
    ...
    title: 'Profil Ananda & Panduan Portal',
    description: 'Menampilkan nama ananda, program kursus, dan nomor terdaftar. Anda bisa mengklik tombol "Panduan" di pojok kanan atas kapan saja untuk membuka kembali tutorial ini.',
  },
  {
    targetId: 'tour-ortu-schedule',
    categoryBadge: '1. MENU BERANDA',
    icon: <CalendarIcon size={20} className="text-[#FF7043]" />,
    title: 'Beranda: Status Pertemuan & Jadwal',
    description: 'Pantau sisa sesi bimbingan ananda per siklus 30 hari, status jatuh tempo SPP, dan jadwal kelas hari ini secara ringkas.',
  },
  {
    targetId: 'tour-ortu-features',
    categoryBadge: '2. MENU ANAK SAYA',
    icon: <DocumentTextIcon size={20} className="text-[#FF7043]" />,
    title: 'Anak Saya: Riwayat Absensi & Catatan Guru',
    description: 'Buka menu "Anak Saya" di bawah untuk melihat log tap kartu RFID real-time, statistik kehadiran, dan catatan evaluasi perkembangan dari guru.',
  },
  {
    targetId: 'tour-ortu-attendance',
    categoryBadge: '3. MENU PEMBAYARAN',
    icon: <CubesIcon size={20} className="text-[#FF7043]" />,
    title: 'Pembayaran SPP & Unggah Bukti Transfer',
    description: 'Buka menu "Pembayaran" di bawah untuk melihat nomor rekening resmi BRI/BCA, mengunggah struk transfer bank, dan memantau verifikasi SPP dari admin.',
  },
  {
    targetId: 'tour-ortu-push',
    categoryBadge: 'NOTIFIKASI PUSH',
    icon: <BellIcon size={20} className="text-[#FF7043]" />,
    title: 'Notifikasi Otomatis ke Layar HP',
    description: 'Aktifkan izin notifikasi peramban agar HP Anda langsung berdering saat ananda hadir di tempat kursus dan saat kuota belajar mendekati habis.',
  },
  {
    targetId: 'tour-ortu-contact',
    categoryBadge: 'LAYANAN BANTUAN',
    icon: <ChatBubbleIcon size={20} className="text-[#FF7043]" />,
    title: 'Kontak Langsung Admin & WhatsApp Direktur',
    description: 'Hubungi Admin untuk perubahan jadwal atau konsultasikan pembayaran langsung ke WhatsApp Direktur Sempoa SIP TC Pariaman.',
  },
];
