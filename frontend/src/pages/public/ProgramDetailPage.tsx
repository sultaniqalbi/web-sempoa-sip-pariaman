...
import { MenuIcon, CloseIcon, HomeIcon, ChevronLeftIcon, ChevronRightIcon, BookOpenIcon, StarIcon, CubesIcon, CheckIcon, GraduationCapIcon, AwardIcon, TrophyIcon, GaleriIcon, MapPinIcon } from '../../components/SvgIcons';
      ...
      <nav className="navbar" id="navbar" style={{ position: 'sticky', top: 0, zIndex: 1000, background: 'rgba(255,255,255,0.98)', borderBottom: '1px solid #e2e8f0' }}>
        <div className="container">
          <Link to="/" className="nav-brand-logo">
            <img src="/assets/logo/logo-sempoa-sip@2x.webp" alt="Sempoa SIP Pariaman" width="100" height="61" />
          </Link>
