...
export const CheckCircleIcon: React.FC<IconProps> = ({ size = 20, className = 'text-current' }) => (
...
export const MailIcon: React.FC<IconProps> = ({ size = 20, className = 'text-current' }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={`shrink-0 ${className}`}>
...
export const GaleriIcon: React.FC<IconProps> = ({ size = 24, className = "" }) => (
  <svg width={size} height={size} className={`shrink-0 ${className}`} fill="none" viewBox="0 0 24 24" stroke="currentColor">
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z" />
  </svg>
);

export const UangIcon: React.FC<IconProps> = ({ size = 24, className = "" }) => (
  <svg width={size} height={size} className={`shrink-0 ${className}`} viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
    <g fill="none">
      <path stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" d="M2 7a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2v10a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V7z" />
...
export const MuridIcon: React.FC<IconProps> = ({ size = 24, className = "" }) => (
  <svg width={size} height={size} className={`shrink-0 ${className}`} viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
...
export const KalenderIcon: React.FC<IconProps> = ({ size = 24, className = "" }) => (
  <svg width={size} height={size} className={`shrink-0 ${className}`} viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
...
export const GuruGroupIcon: React.FC<IconProps> = ({ size = 24, className = "" }) => (
  <svg width={size} height={size} className={`shrink-0 ${className}`} viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
...
export const BookIcon: React.FC<IconProps> = ({ size = 20, className = 'text-current' }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={`shrink-0 ${className}`}>
...
export const EvaluasiIcon: React.FC<IconProps> = ({ size = 20, className = 'text-current' }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={`shrink-0 ${className}`}>
...
export const JamIcon: React.FC<IconProps> = ({ size = 20, className = 'text-current' }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={`shrink-0 ${className}`}>
    <circle cx="12" cy="12" r="10"/>
...
export const PencilIcon: React.FC<IconProps> = ({ size = 20, className = 'text-current' }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={`shrink-0 ${className}`}>
    <path d="M17 3a2.828 2.828 0 1 1 4 4L7.5 20.5 2 22l1.5-5.5L17 3z" />
  </svg>
);

export const CatatanIcon: React.FC<IconProps> = ({ size = 20, className = 'text-current' }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={`shrink-0 ${className}`}>
    <path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z" />
    <polyline points="14 2 14 8 20 8" />
    <line x1="16" y1="13" x2="8" y2="13" />
...
export const RiwayatIcon: React.FC<IconProps> = ({ size = 20, className = 'text-current' }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={`shrink-0 ${className}`}>
...
// ──────────────────────────────────────────────
// 4. New Real SVG Icons replacing Emojis / FontAwesome
// ──────────────────────────────────────────────
export const AlertCircleIcon: React.FC<IconProps> = ({ size = 20, className = 'text-current' }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={`shrink-0 ${className}`}>
    <circle cx="12" cy="12" r="10" />
...
export const HelpCircleIcon: React.FC<IconProps> = ({ size = 20, className = 'text-current' }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={`shrink-0 ${className}`}>
    <circle cx="12" cy="12" r="10" />
...
export const BanIcon: React.FC<IconProps> = ({ size = 20, className = 'text-current' }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={`shrink-0 ${className}`}>
    <circle cx="12" cy="12" r="10" />
...
export const CalculatorIcon: React.FC<IconProps> = ({ size = 20, className = 'text-current' }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={`shrink-0 ${className}`}>
    <rect x="4" y="2" width="16" height="20" rx="2" />
    <line x1="8" y1="6" x2="16" y2="6" />
    <line x1="16" y1="14" x2="16" y2="18" />
    <circle cx="8.5" cy="11.5" r=".75" fill="currentColor" />
    <circle cx="12" cy="11.5" r=".75" fill="currentColor" />
    <circle cx="15.5" cy="11.5" r=".75" fill="currentColor" />
    <circle cx="8.5" cy="15" r=".75" fill="currentColor" />
    <circle cx="12" cy="15" r=".75" fill="currentColor" />
    <circle cx="8.5" cy="18" r=".75" fill="currentColor" />
    <circle cx="12" cy="18" r=".75" fill="currentColor" />
  </svg>
);

export const RocketIcon: React.FC<IconProps> = ({ size = 20, className = 'text-current' }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={`shrink-0 ${className}`}>
...
export const RefreshIcon: React.FC<IconProps> = ({ size = 20, className = 'text-current' }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={`shrink-0 ${className}`}>
    <path d="M21.5 2v6h-6" />
...
export const UploadIcon: React.FC<IconProps> = ({ size = 20, className = 'text-current' }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={`shrink-0 ${className}`}>
...
export const RotateLeftIcon: React.FC<IconProps> = ({ size = 16, className = 'text-current' }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={`shrink-0 ${className}`}>
    <path d="M2.5 2v6h6" />
...
export const RotateRightIcon: React.FC<IconProps> = ({ size = 16, className = 'text-current' }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={`shrink-0 ${className}`}>
    <path d="M21.5 2v6h-6" />
...
export const FlipHorizontalIcon: React.FC<IconProps> = ({ size = 16, className = 'text-current' }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={`shrink-0 ${className}`}>
    <path d="m3 7 5 5-5 5V7zm18 0-5 5 5 5V7zM12 2v20" />
  </svg>
);

export const FlipVerticalIcon: React.FC<IconProps> = ({ size = 16, className = 'text-current' }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={`shrink-0 ${className}`}>
    <path d="m7 3 5 5 5-5H7zm0 18 5-5 5 5H7zM2 12h20" />
  </svg>
);

export const SortAscIcon: React.FC<IconProps> = ({ size = 14, className = 'text-current' }) => (
...
export const SortDescIcon: React.FC<IconProps> = ({ size = 14, className = 'text-current' }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" className={`shrink-0 ${className}`}>
    <path d="m6 9 6 6 6-6" />
  </svg>
);

export const SortDefaultIcon: React.FC<IconProps> = ({ size = 14, className = 'text-current' }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={`shrink-0 ${className}`}>
    <path d="m7 15 5 5 5-5M7 9l5-5 5 5" />
  </svg>
);

export const ArrowUpIcon: React.FC<IconProps> = ({ size = 14, className = 'text-current' }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" className={`shrink-0 ${className}`}>
...
export const ArrowDownIcon: React.FC<IconProps> = ({ size = 14, className = 'text-current' }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" className={`shrink-0 ${className}`}>
...
export const StatusDotIcon: React.FC<IconProps> = ({ size = 10, className = 'text-current' }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor" className={`shrink-0 ${className}`}>
    <circle cx="12" cy="12" r="10" />
  </svg>
);

export const LevelUpIcon: React.FC<IconProps> = ({ size = 16, className = 'text-current' }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={`shrink-0 ${className}`}>
...
export const TrendUpIcon: React.FC<IconProps> = ({ size = 16, className = 'text-current' }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round" className={`shrink-0 ${className}`}>
    <polyline points="23 6 13.5 15.5 8.5 10.5 1 18" />
    <polyline points="17 6 23 6 23 12" />
  </svg>
);

export const ChartAreaIcon: React.FC<IconProps> = ({ size = 16, className = 'text-current' }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={`shrink-0 ${className}`}>
    <path d="M3 3v18h18" />
    <path d="M7 14l4-5 4 3 5-7v9H7z" fill="currentColor" fillOpacity="0.2" />
    <path d="M7 14l4-5 4 3 5-7" />
  </svg>
);

export const ChartBarIcon: React.FC<IconProps> = ({ size = 16, className = 'text-current' }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round" className={`shrink-0 ${className}`}>
