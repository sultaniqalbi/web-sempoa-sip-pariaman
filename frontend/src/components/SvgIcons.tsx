...
// 45. Evaluasi / Rapor Perkembangan Icon
...
// 47. User Icon
export const UserIcon: React.FC<IconProps> = ({ size = 20, className = 'text-current' }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={`shrink-0 ${className}`}>
...
// 49. Cubes Icon
export const CubesIcon: React.FC<IconProps> = ({ size = 20, className = 'text-current' }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={`shrink-0 ${className}`}>
...
// 51. Presensi Icon
export const PresensiIcon: React.FC<IconProps> = ({ size = 20, className = 'text-current' }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={`shrink-0 ${className}`}>
    <rect x="3" y="4" width="18" height="18" rx="2" ry="2"/>
    <line x1="16" y1="2" x2="16" y2="6"/>
    <line x1="8" y1="2" x2="8" y2="6"/>
...
// 53. Edit Icon
export const EditIcon: React.FC<IconProps> = ({ size = 20, className = 'text-current' }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={`shrink-0 ${className}`}>
...
// 54. Logout Icon
export const LogoutIcon: React.FC<IconProps> = ({ size = 20, className = 'text-current' }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={`shrink-0 ${className}`}>
...
// 55. Pembayaran Icon
export const PembayaranIcon: React.FC<IconProps> = ({ size = 20, className = 'text-current' }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={`shrink-0 ${className}`}>
...
// 57. Data Siswa Icon
export const DataSiswaIcon: React.FC<IconProps> = ({ size = 20, className = 'text-current' }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={`shrink-0 ${className}`}>
...
// 58. Close Icon
export const CloseIcon: React.FC<IconProps> = ({ size = 20, className = 'text-current' }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={`shrink-0 ${className}`}>
