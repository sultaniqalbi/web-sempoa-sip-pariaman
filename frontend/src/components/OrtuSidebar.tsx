...
export const OrtuSidebar: React.FC<SidebarProps> = ({ onClose, isCollapsed = false }) => {
      ...
      <div className="p-4 sm:p-5">
        <div className={`flex items-center justify-between mb-6 ${isCollapsed ? 'justify-center' : ''}`}>
          <div className="flex items-center gap-3">
            ...
            {!isCollapsed && (
              <div>
                <h1 className="font-extrabold text-sm text-[#1E293B] tracking-tight leading-tight" style={{ fontFamily: "'Poppins', sans-serif" }}>PORTAL ORTU</h1>
